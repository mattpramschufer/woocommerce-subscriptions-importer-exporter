			...
			if ( empty( $result['error'] ) || self::$test_mode ) {
				try {
					if ( ! self::$test_mode ) {
						...
						$order = wc_create_order( array( 'customer_id' => $user_id, 'post_date' => '1994-10-13 9:00:00', 'order_date' => '1994-10-13 9:00:00' ) );
						...
						wp_update_post( array( 'ID' => $the_order_id, 'post_date' => $data['last_payment_date'], 'post_date_gmt' => $data['last_payment_date'] ) );
